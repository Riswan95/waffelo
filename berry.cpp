...
//=============================================================================
bool Berry::initialize(Game *gamePtr, int width, int height, int ncols,
...
//=============================================================================
void Berry::update(float frameTime)
{
