...
//=============================================================================
bool JumpHigh::initialize(Game *gamePtr, int width, int height, int ncols,
...
//=============================================================================
void JumpHigh::update(float frameTime)
{
